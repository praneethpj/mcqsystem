...
--
-- Host: localhost
-- Generation Time: Dec 16, 2016 at 10:01 AM
...
CREATE TABLE `blog` (
  ...
  `blog_title` varchar(250) COLLATE utf8_unicode_ci,
...
CREATE TABLE `categories` (
  ...
  `category_name` varchar(200) COLLATE utf8_unicode_ci,
  `created_by` int(5),
  `active` int(1) NOT NULL DEFAULT '1',
  `last_modified_by` int(5),
...
CREATE TABLE `content` (
  ...
  `content_type` varchar(100) COLLATE utf8_unicode_ci,
...
CREATE TABLE `courses` (
  ...
  `course_title` text COLLATE utf8_unicode_ci,
  ...
  `course_rating` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `course_view_count` int(11),
  `created_by` int(11),
  `active` int(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `course_sections` (
  ...
  `section_name` varchar(50) COLLATE utf8_unicode_ci,
  `section_title` text COLLATE utf8_unicode_ci,
  `course_id` int(11),
  `video_ids` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `doc_ids` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `audio_ids` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ppt_ids` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `course_videos` (
  ...
  `orderList` int(5) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `exam_title` (
  ...
  `title_name` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `faqs` (
  ...
  `faq_created_by` int(5),
  `faq_last_modified_by` int(5),
  `faq_last_update` date,
  `faq_grp_id` int(11)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `messages` (
  ...
  `message_sender` varchar(100) CHARACTER SET utf8,
  `sender_email` varchar(100) CHARACTER SET utf8,
  `message_send_to` varchar(100) CHARACTER SET utf8,
  `message_subject` text CHARACTER SET utf8,
  `message_body` text CHARACTER SET utf8,
  `message_date` datetime,
  `message_folder` varchar(10) CHARACTER SET utf8,
...
CREATE TABLE `price_table` (
  ...
  `price_table_title` varchar(255) COLLATE utf8_unicode_ci,
  `price_table_cost` varchar(20) COLLATE utf8_unicode_ci,
  `offer_duration` int(11),
  `offer_type` varchar(10) COLLATE utf8_unicode_ci,
...
CREATE TABLE `questions` (
  ...
  `media_type` varchar(10) COLLATE utf8_unicode_ci,
...
CREATE TABLE `result` (
  ...
  `question_answered` int(3),
  `exam_taken_date` datetime,
...
CREATE TABLE `settings` (
  ...
  `brand_tagline` varchar(250),
  `local_time_zone` varchar(100),
...
(1, 'Minor School', 'Learning freedom for all.', 'Asia/Dhaka', 'support@demo.com', '09999999', '121 King Street, Melbourne  Victoria 3000 Australia', 'https://www.facebook.com/ahkmunna', '', 'https://twitter.com/ahkmunna', 'https://www.youtube.com/watch?v=dlJshzOv2cw', '', 'https://twitter.com/ahkmunna', 'https://twitter.com/ahkmunna', 1, 1, '2016-12-15', 1);
...
CREATE TABLE `users` (
  `user_id` int(5) NOT NULL,
  `user_name` varchar(200) COLLATE utf8_unicode_ci,
  `user_email` varchar(150) CHARACTER SET utf8 NOT NULL,
  `user_phone` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `user_role_id` int(5) NOT NULL DEFAULT '5',
  ...
  `subscription_start` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `subscription_end` text COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(2, 'Admin One', 'admin@demo.com', '', 2, 'e10adc3949ba59abbe56e057f20f883e', 1, 0, '2016-01-04 20:17:37', 0, '', ''),
(3, 'Moderator', 'moderator@demo.com', '', 4, 'e10adc3949ba59abbe56e057f20f883e', 1, 0, '2016-01-04 20:18:20', 0, '', ''),
(4, 'Teacher', 'teacher@demo.com', '', 4, 'e10adc3949ba59abbe56e057f20f883e', 1, 0, '2016-01-04 20:18:56', 0, '', ''),
(5, 'Student', 'student@demo.com', '', 5, 'e10adc3949ba59abbe56e057f20f883e', 1, 0, '2016-01-04 20:19:33', 0, '', '');
