                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="<?= ($i & 1) ? 'even' : 'odd'; ?>">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-success btn-sm" href = "<?= base_url('index.php/mock_detail/' . $mock->title_id); ?>"><span class="invisible-on-md">  View Questions</span></a>
                                            <a class="btn btn-info btn-sm" href = "<?= base_url('index.php/admin_control/edit_mock_detail/' . $mock->title_id); ?>"><span class="invisible-on-md">  View Detail</span></a>
