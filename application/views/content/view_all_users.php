            ...
            foreach ($users as $user) { 
               if (($user->active == 1) && ($user->banned == 0) && ($user->user_role_id == 4)) { ?>
                <tr class="<?=($i & 1) ? 'even' : 'odd'; ?>">
                    ...
                    <td style="width: 30%">
                    <div class="btn-group">
                        <a class="btn btn-default btn-xs" href = "<?=base_url('index.php/user_control/modify_user/' .$user->user_id);?>"><i class="glyphicon glyphicon-edit"></i><span class="invisible-on-xs">  Modify</span></a>
                        ...
                        <a onclick="return deactivate_confirmation('<?=$user->user_name?>')" href = "<?php echo base_url('index.php/user_control/deactivate_user_account/' . $user->user_id); ?>" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md">  Deactivate</span></a>
                    </div>
                    </td>
                </tr>
                <?php $i++;
