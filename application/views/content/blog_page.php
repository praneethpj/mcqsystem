                ...
                <div class="col-md-10 col-sm-12 col-md-offset-1 col-sm-offset-0">
                    ...
                    <div class="blog"><!-- /.row Start-->
                        ...
                        <?php foreach ($blogs as $value) { ?>
                            <div class="blog-post">
                                <h1 class="text-center"><a href="<?=base_url('index.php/blog/post/'.$value->blog_id); ?>"><?=$value->blog_title; ?></a></h1>
                                ...
                                <div class="read-more"><a href="<?=base_url('index.php/blog/post/'.$value->blog_id); ?>" class="btn btn-default btn-sm col-sm-4 col-sm-offset-4"> Read More </a></div>
                            </div>
                        <?php } ?>
                    </div><!-- /.row End-->
