                                    ...
                                    foreach ($users as $user) {
                                        if (($user->active == 0) && ($user->user_role_id > $this->session->userdata['user_role_id'])) {
                                            ...
                                            <tr class="<?= ($i & 1) ? 'even' : 'odd'; ?>">
                                                ...
                                                <td style=" width: 13%">
                                                    <a onclick="return are_you_sure()" class="btn btn-primary" href = "<?php echo base_url('index.php/user_control/activate_user_account/' . $user->user_id); ?>"><i class="glyphicon glyphicon-check"></i><span class="invisible-on-md">  Activate </span></a>
                                                </td>
                                            </tr>
                                            <?php
                                            $i++;
                                    ...
                                    if (($user->banned == 1) && ($user->user_role_id > $this->session->userdata['user_role_id'])) {
                                        ?>
                                            <tr class="<?= ($i & 1) ? 'even' : 'odd'; ?>">
                                                ...
                                                <td class="hidden-xxs"><?= $user->user_role_name; ?></td>
                                                <td style=" width: 13%">
                                                    <a onclick="return are_you_sure()" class="btn btn-primary" href = "<?php echo base_url('index.php/user_control/unban_user_account/' . $user->user_id); ?>"><i class="glyphicon glyphicon-check"></i><span class="invisible-on-md">  Unban </span></a>
                                                </td>
                                            </tr>
                                <?php
                                $i++;
