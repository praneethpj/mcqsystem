        ...
        <div class="row">
            <p class="text-muted">FAQs 
                <?php if ($this->session->userdata['user_role_id'] < 4) { ?>
                    ...
                    <a class="btn custom_navbar-btn btn-primary pull-right col-sm-2" href="<?=base_url('index.php/faq_control/faq_form'); ?>"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; New FAQ </a>
                <?php } ?>
            </p>
        </div>
    </div>
                                                ...
                                                <td class="col-xs-3 text-center">
                                                    <div class="btn-group">
                                                        <?php if ($this->session->userdata['user_role_id'] <= 3) { ?>
                                                            ...
                                                            <a class="btn btn-default btn-xs" href = "<?=base_url('index.php/faq_control/update_faq/'.$faq->faq_id); ?>"><i class="glyphicon glyphicon-edit"></i><span class="invisible-on-md">  Modify</span></a>
                                                            <a onclick="return delete_confirmation()" href = "<?=base_url('index.php/faq_control/delete_faq/' . $faq->faq_id); ?>" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md">  Delete</span></a>
                                                        <?php } ?>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        foreach ($faq_grps as $faq_grp) { ?>
                            <tr class="<?= ($i & 1) ? 'even' : 'odd'; ?>">
                                ...
                                <td class="col-xs-3 text-center">
                                    <div class="btn-group">
                                        <?php if ($this->session->userdata['user_role_id'] <= 3) { ?>
                                            <a class="btn btn-default btn-xs" href = "<?=base_url('index.php/faq_control/update_faq_grp/'.$faq_grp->faq_grp_id); ?>"><i class="glyphicon glyphicon-edit"></i><span class="invisible-on-md">  Modify</span></a>
                                            <a onclick="return delete_confirmation()" href = "<?=base_url('index.php/faq_control/delete_faq_grp/' . $faq_grp->faq_grp_id); ?>" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md">  Delete</span></a>
                                        <?php } ?>
                                    </div>
                                </td>
                            </tr>
