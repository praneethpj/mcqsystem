...
<ol class="breadcrumb">
  ...
  <li><a href="<?=base_url('index.php/message_control');?>"><i class="fa fa-envelope-o"></i> Inbox</a></li>
 ...
 <div class="message-display-head">
    ...
    <span class="message-display-sender">
        ...
        if (($message->message_folder == 'draft')OR($message->message_folder == 'send')) {
            echo 'To: '.'< '.$message->message_send_to.' > '; 
        } else {
    ...
    <div class="btn-group pull-right hidden-xs">
        ...
        <a onclick="return delete_confirmation()" href="<?=base_url('index.php/message_control/delete_message/'.$message->message_id); ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md"> Delete </span></a>
...
<div class="row visible-xs">
    <div class="btn-group pull-right col-xs-pull-1">
        ...
        <a onclick="return delete_confirmation()" href="<?=base_url('index.php/message_control/delete_message/'.$message->message_id); ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-trash"></i> Delete </a>
