                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-hover">
                   ...
                   <tr class="<?=($i & 1) ? 'even' : 'odd'; echo($msg->message_read == 0) ? ' bold-text ' : ' '; ?>" href="<?=base_url('index.php/message_control/open_message/'.$msg->message_id); ?>">
                       ...
                       <td class="col-sm-2 text-center">
                           <div class="btn-group">
                               <a href="<?php echo base_url('index.php/message_control/move_message/untrash/' . $msg->message_id); ?>" class="btn btn-sm btn-default"><i class="fa fa-reply"></i><span class="invisible-on-sm"> Inbox</span></a>
                               <button type="button" class="btn  btn-sm btn-default dropdown-toggle" data-toggle="dropdown">
                                <span class="caret"></span>
                               </button>
                               <ul class="dropdown-menu text-left" role="menu">
                                  <li><a href="<?php echo base_url('index.php/message_control/move_message/untrash/' . $msg->message_id) ; ?>"><i class="glyphicon glyphicon-envelope"></i><span class="invisible-on-sm"> Move to</span> Inbox </a></li>
                                  <li class="divider"></li>
                                  <li><a onclick="return delete_confirmation()" href = "<?php echo base_url('index.php/message_control/delete_message/' . $msg->message_id); ?>"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md">  Delete forever</span></a></li>
                               </ul>
                           </div>
                       </td>
                   </tr>
            ...
            <div class="tab-pane" id="tab_Drafts">
                <table cellpadding="0" cellspacing="0" border="0" class="table table-hover">
                   ...
                   <tr class="<?=($i & 1) ? 'even' : 'odd'; echo($msg->message_read == 0) ? ' bold-text ' : ' '; ?>" href="<?=base_url('index.php/message_control/open_message/'.$msg->message_id); ?>">
                       ...
                       <td class="col-sm-2 text-center">
                           <div class="btn-group">
                               <a href="<?php echo base_url('index.php/message_control/reply_message/' . $msg->message_id); ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-edit"></i><span class="invisible-on-sm"> Edit</span></a>
                               <a onclick="return delete_confirmation()" href = "<?php echo base_url('index.php/message_control/delete_message/' . $msg->message_id); ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-sm"> Delete</span></a>
                           </div>
                       </td>
                   </tr>
                   <?php
            ...
            <div class="tab-pane" id="tab_Send">
                <table cellpadding="0" cellspacing="0" border="0" class="table table-hover">
                   ...
                   <tr class="<?=($i & 1) ? 'even' : 'odd'; echo($msg->message_read == 0) ? ' bold-text ' : ' '; ?>" href="<?=base_url('index.php/message_control/open_message/'.$msg->message_id); ?>">
                       ...
                       <td class="col-sm-2 text-center">
                           <div class="btn-group">
                               <a href="<?php echo base_url('index.php/message_control/reply_message/' . $msg->message_id); ?>" class="btn btn-sm btn-default"><i class="fa fa-reply"></i><span class="invisible-on-sm"> Reply</span></a>
                               <button type="button" class="btn  btn-sm btn-default dropdown-toggle" data-toggle="dropdown">
                                <span class="caret"></span>
                               </button>
                               <ul class="dropdown-menu text-left" role="menu">
                                  <li><a href="<?php echo base_url('index.php/message_control/move_message/spam/' . $msg->message_id) ; ?>"><i class="glyphicon glyphicon-minus-sign"></i><span class="invisible-on-sm"> Mark as</span> Spam </a></li>
                                  <li class="divider"></li>
                                  <li><a href = "<?php echo base_url('index.php/message_control/move_message/trash/' . $msg->message_id) ; ?>"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-sm"> Move to</span> Trash</a></li>
                               </ul>
                           </div>
                       </td>
                   </tr>
