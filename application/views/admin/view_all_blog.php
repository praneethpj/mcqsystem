    ...
    <div class="navbar block-inner block-header">
        <div class="row">
            <p class="text-muted">Blog posts 
                <a class="btn custom_navbar-btn btn-primary pull-right col-sm-3" href="<?php echo base_url('index.php/blog/add'); ?>"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; Add Post </a>
            </p>
        </div>
    </div>
                                ...
                                <tr class="<?= ($i & 1) ? 'even' : 'odd'; ?>">
                                    ...
                                    <td class="col-xs-3 text-center">
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-default btn-sm" href = "<?php echo base_url('index.php/blog/edit/' . $blog->blog_id); ?>"><i class="glyphicon glyphicon-edit"></i><span class="invisible-on-md">  Modify</span></a>
                                            <?php if ($this->session->userdata['user_role_id'] <= 2) { ?>
                                                <a onclick="return delete_confirmation()" href = "<?php echo base_url('index.php/blog/delete/' . $blog->blog_id); ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md">  Delete</span></a>
                                                    <?php } ?>
                                        </div>
                                    </td>
                                </tr>
