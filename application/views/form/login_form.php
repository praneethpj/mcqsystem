        ...
        <div class="box">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-8 col-md-offset-4 col-sm-offset-2">
                    ...
                    <i class="glyphicon glyphicon-question-sign"> </i> <a href="<?=base_url('index.php/login_control/password_recovery_form'); ?>"> Forgot Password.</a>
                        <?php if ($this->session->userdata('student_can_register')){  ?>
                     New user? <a href="<?=base_url('index.php/login_control/register'); ?>"> Register</a> from here.
                     <?php } ?>
                </div>
                </div>
            </div>
