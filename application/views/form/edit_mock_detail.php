    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <p class="help-block info"><strong><i class="glyphicon glyphicon-warning-sign"></i> If No, This exam will not available on exam page but can be linked with any course.  </strong></p>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <p class="help-block info"><i class="glyphicon glyphicon-warning-sign"></i> Total available questions <?=$ques_count;?></p>
            </div>
